...
Describe 'Add-DynamicParam' -Tag Add-DynamicParam,Add,'DynamicParam' {
	Context 'Adding parameters' {
		It "Should add a required string parameter" {
			function Trace-RequiredParameter
			{
				[CmdletBinding()] Param()
				DynamicParam
				{
					...
					Get-Variable -Name DynamicParams |Should -BeTrue -Because 'it should exist within the DynamicParam block'
				}
				Process
				{
					Get-Variable -Name DynamicParams |Should -BeTrue -Because 'it should exist now'
			...
			Trace-RequiredParameter
		}
		It "Should add several alternative parameters" {
			function Trace-AddMultipleParameters
			{
				[CmdletBinding()] Param()
				DynamicParam
				{
