...
.EXAMPLE
Get-CommandParameters Write-Verbose
...
.EXAMPLE
Get-CommandParameters Out-Default -NamesOnly
...
Process
{
	...
	if(!$cmd) {Stop-ThrowError "Cmdlet not found: $CommandName" -ParameterName CommandName}
	if($ParameterSet)
	{
