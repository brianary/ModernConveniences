...
.EXAMPLE
@{b=0;c=3},@{c=4;d=5} |Join-Keys @{a=1;b=2} -Force |foreach {$_ |ConvertTo-Json -Compress}

{"c":3,"b":0,"a":1}
{"d":5,"b":2,"c":4,"a":1}

.EXAMPLE
@{b=0;c=3},@{c=4;d=5} |Join-Keys @{a=1;b=2} -Force -Accumulate |foreach {$_ |ConvertTo-Json -Compress}

{"c":3,"b":0,"a":1}
{"c":4,"b":0,"d":5,"a":1}

.EXAMPLE
@{b=0;c=3},@{c=4;d=5} |Join-Keys -Accumulate |select -Last 1
