...
.EXAMPLE
Get-Item Save-*.ps1 |Export-MermaidXY -Title "Save scripts" -Units bytes -LabelProperty Name -BarProperty Length

xychart-beta
title "Save scripts"
x-axis "" [Save-PodcastEpisodes, Save-Secret, Save-WebRequest]
y-axis "bytes" 0 --> 3239
