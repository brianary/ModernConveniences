...
.EXAMPLE
Select-String '(<!-- generated) .*? (-->)' README.md |Set-RegexReplace "`$1 $(Get-Date) `$2"

Updates the generated date in README.md.

.EXAMPLE
Get-Item README.md |select Name,Length |ConvertTo-Html -Fragment |Out-String |Select-String '(<td)(>\d+</td>)' |Set-RegexReplace '$1 align="right"$2'
