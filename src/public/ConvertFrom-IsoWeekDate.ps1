...
.EXAMPLE
ConvertFrom-IsoWeekDate 2000-W01-1

Monday, January 3, 2000 00:00:00

.EXAMPLE
ConvertFrom-IsoWeekDate 2022-W08-2
...
Process
{
	...
	{
		Stop-ThrowError "Unable to parse '$InputObject' as an ISO week date." -Argument InputObject
	}
